...
import SellParkingScreen from './screens/SellParkingScreen';
  ...
  return (
    <NavigationContainer linking={LinkingConfiguration}>
      ...
      >
        ...
        />
        <Stack.Screen
          name="SellParkingScreen"
          component={SellParkingScreen}
          options={{
            title: 'Sell Parking',
          }}
        />
        <Stack.Screen
          name="AddressCheckScreen"
          component={AddressCheckScreen}
          options={{
            title: 'Address Check',
          }}
        />
